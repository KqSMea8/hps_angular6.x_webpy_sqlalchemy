...
from utils.tools import is_null, dict_to_name
...
class handler(object):
    ...
    def data_handle(self):
        ...
        return self.search_user_list(objCondition['nSearchUserIDMust'], objCondition['sSearchUserNameMust'], objPageInfo, objCondition)

    def search_user_list(self, nSearchUserIDMust, sSearchUserNameMust, objPageInfo, objCondition):
        ...
        if objData:
            for objUser in objData.data['data']:
                objUser['StateName'] = dict_to_name(objUser['State'], 'user_state')
            dictData = {
